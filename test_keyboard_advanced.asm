...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing keyboard functions' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Note: This test runs headlessly, so KEYIN/KEYSTAT will return 0' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; KeyAvailable = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'KEYSTAT() =' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'KEYIN() =' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing keyboard polling...' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; For I = 1 To 10
...
DW 0  ; Variable Z
ORG 0x2034
DW 0  ; Variable KEYAVAILABLE
ORG 0x2036
DW 0  ; Variable KEYPRESSED
ORG 0x2038
