...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'SELECT CASE Test' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
...
case_next_3:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'THREE' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    JMP select_end_1
...
case_next_4:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'OTHER' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    JMP select_end_1
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Test completed' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    JMP select_end_1
