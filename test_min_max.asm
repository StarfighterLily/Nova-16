...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing MIN/MAX functions' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'MIN(50, 25) = ' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'MAX(50, 25) = ' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'MIN(X+5, Y-10) = ' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'MAX(X*2, Y/2) = ' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'MIN/MAX tests complete' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
