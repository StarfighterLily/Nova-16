...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing math functions' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Random numbers:' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; For I = 1 To 5
...
for_loop_1:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Random' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Random in range 1-10:' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    ; For I = 1 To 5
...
for_loop_3:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Range random' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'SQRT(16) =' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'SQRT(2) â‰ˆ' using TEXT
    MOV P0,0x4900
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'ABS(-5) =' using TEXT
    MOV P0,0x4A00
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'ABS(3) =' using TEXT
    MOV P0,0x4B00
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Math functions test complete' using TEXT
    MOV P0,0x4C00
    MOV P1,15
    TEXT P0,P1
