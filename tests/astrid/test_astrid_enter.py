...
# Fixture binaries live in tests/astrid/fixtures; generated program
# outputs (simple.asm/simple.bin) live in the astrid/progs/ directory.
FIXTURES_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'fixtures')
PROGS_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'astrid', 'progs')
...
def test_enter_leave_stack_frame():
    ...
    # test_enter_leave.bin lives in tests/astrid/fixtures
    bin_path = os.path.join(FIXTURES_DIR, 'test_enter_leave.bin')
...
def test_astrid_codegen_uses_enter():
    ...
    asm_path = os.path.join(PROGS_DIR, 'simple.asm')
...
def test_astrid_simple_runs():
    ...
    bin_path = os.path.join(PROGS_DIR, 'simple.bin')
    proc, cycles = run_binary(bin_path)
