...
class TestNoBasicCompiler(unittest.TestCase):
    ...
    def test_compile_disp_string(self):
        ...
        lines = self.compiler._compile_disp(tokens, 0)

        # Should generate TEXT instruction
    ...
    def test_compile_assignment_simple(self):
        ...
        tokens = ['A', '=', '42', '\n']
        lines = self.compiler._compile_assignment('A', tokens, 0)

        self.assertIn("    ; A = 42 (optimized direct assignment)", lines)
