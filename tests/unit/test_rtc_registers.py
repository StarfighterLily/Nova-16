...
def test_rtc_registers_round_trip_through_cpu_and_tooling(cpu, monkeypatch, tmp_path):
    ...
    assert cpu.reg_index(opcode_value('C0')) == (0, 'C0')
    assert cpu.reg_index(opcode_value('C1')) == (0, 'C1')
