...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing advanced string functions' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; Str1 = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'LOWER('Hello World'):' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'TRIM('  Hello World  '):' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'REPLACE('Hello World', 'World', 'Universe'):' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'SPLIT result array created' using TEXT
    MOV P0,0x4B00
    MOV P1,15
    TEXT P0,P1
    ; JoinStr = 
    ; Load SplitArray into P0
    MOV P0,[0x2044]
    MOV P1,19456
    MOV P2,3
    ; JOIN(P0, P1, P2)
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'JOIN result:' using TEXT
    MOV P0,0x4D00
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'INSTR('Hello World', 'xyz'):' using TEXT
    MOV P0,0x5000
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Advanced string functions test complete' using TEXT
    MOV P0,0x5100
    MOV P1,15
    TEXT P0,P1
...
DW 0  ; Variable STR1
ORG 0x2036
DW 0  ; Variable LOWERSTR
ORG 0x2038
DW 0  ; Variable UPPERSTR
ORG 0x203A
DW 0  ; Variable STR2
ORG 0x203C
DW 0  ; Variable TRIMSTR
ORG 0x203E
DW 0  ; Variable STR3
ORG 0x2040
DW 0  ; Variable REPLACESTR
ORG 0x2042
DW 0  ; Variable STR4
ORG 0x2044
DW 0  ; Variable SPLITARRAY
ORG 0x2046
DW 0  ; Variable JOINSTR
ORG 0x2048
DW 0  ; Variable POS1
ORG 0x204A
DW 0  ; Variable POS2
