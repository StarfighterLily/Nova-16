...
RNDR P0, 0, 256
    ...
    SUB P1, 8              ; Subtract for negative offset (-8)
    MOV [P1], P0                  ; Store return value to v2
    MOV P0, FP                ; Load base pointer
...
; Generate random number between 0 and 15 (8-bit)
RNDR P0, 0, 15
    MOV P1, FP                ; Load base pointer
    SUB P1, 18              ; Subtract for negative offset (-18)
    MOV [P1], P0                  ; Store return value to v7
    MOV P0, FP                ; Load base pointer
