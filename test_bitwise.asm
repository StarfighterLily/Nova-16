...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing bitwise operations' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '12 AND 10 =' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '12 OR 10 =' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '12 XOR 10 =' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'NOT 5 =' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '3 SHL 2 =' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '12 SHR 2 =' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Complex bitwise =' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Bitwise operations test complete' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
