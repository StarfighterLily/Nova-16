...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing keyboard input' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Press keys to test input...' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Initial keystat:' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Press a key for KEYIN test:' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; B = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'KEYIN result:' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Press 3 keys quickly:' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    ; For I = 1 To 3
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing key buffer...' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    ; Count = 
...
for_loop_3:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Buffered key:' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
if_else_5:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'No key available' using TEXT
    MOV P0,0x4900
    MOV P1,15
    TEXT P0,P1
    ; For J = 1 To 100
...
for_loop_7:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Keys read:' using TEXT
    MOV P0,0x4A00
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Keyboard test complete' using TEXT
    MOV P0,0x4B00
    MOV P1,15
    TEXT P0,P1
if_else_5:
