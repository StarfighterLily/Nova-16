...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing Improved Arrays' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV [0x6000],P0
    ; Array TEST_ARRAY data address: 0x6002
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Array declared with size:' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
for_loop_1:
    ...
    ; Load I into P1
    MOV P1,[0x2010]
    ; Store to TEST_ARRAY[P1]
    ; Bounds check: 0 <= P1 < [24576]
    MOV P3,[0x6000]
    CMP P1,P3
    JC bounds_ok_3
    ; Bounds check failed - index out of range
    ; For now, continue execution (TODO: proper error handling)
bounds_ok_3:
    LEA P2,[0x6002 + P1*2]
    MOV [P2],P0
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'TEST_ARRAY[' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing bounds:' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; X = 
    MOV P0,0
    ; Load TEST_ARRAY[P0] into P1
    ; Bounds check: 0 <= P0 < [24576]
    MOV P3,[0x6000]
    CMP P0,P3
    JC bounds_ok_4
    ; Bounds check failed - index out of range
...
bounds_ok_5:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'First element:' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Last element:' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
bounds_ok_6:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'TEST_ARRAY[2+1] =' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Array tests completed!' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
