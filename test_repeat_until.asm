...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing REPEAT/UNTIL' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Repeat count:' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Basic repeat done' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    ; B = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Countdown:' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Countdown done' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; X = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Nested repeat:' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Nested repeat done' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
