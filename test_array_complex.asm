...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing array literals and complex indexing' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Array literal created' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; I = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'A[2+1] =' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'A[1+1] set to 99' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; Val2 = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'L1(1+1) =' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Array and list complex indexing test complete' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
