...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing sprites and layers' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; VL = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Layer 1 operations' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; Pxl-On
    ...
    ADD P6,P2
    DEC P6
    ; Draw rectangle from (P1,P0) to (P5,P6)
    MOV VX,P1
    MOV VY,P0
    MOV VC,P3
    SRECT P5,P6,0
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Layer 2 operations' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    ; Pxl-On
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Layer 3 operations' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; Pxl-On
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sprite control blocks:' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sprite 0: 0xF000' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sprite 1: 0xF010' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sprite 15: 0xF0F0' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    ; VM = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sprites and layers test complete' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
