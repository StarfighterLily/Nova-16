...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing enhanced sound' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; SA = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Basic sound playing' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; SA = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Multiple sounds playing' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    ; SA = 
...
for_loop_3:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Sound sequence complete' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; For V = 255 To 0
...
for_loop_7:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Enhanced sound test complete' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
