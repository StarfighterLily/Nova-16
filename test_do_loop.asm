...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing DO/LOOP constructs' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; A = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Basic loop:' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Basic loop done' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    ; B = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'While loop:' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'While loop done' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
    ; C = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Until loop:' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Until loop done' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
    ; X = 
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Nested:' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Nested loops done' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
