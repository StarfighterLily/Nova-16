...
start:
    ...
    ; Struct PLAYER defined with 4 fields, total size 8 bytes
    ;   X: offset 0, size 2
    ;   Y: offset 2, size 2
    ;   HEALTH: offset 4, size 2
    ;   SCORE: offset 6, size 2
    ; STRUCT - structure definition
    ; Struct VEC2 defined with 2 fields, total size 4 bytes
    ;   X: offset 0, size 2
    ;   Y: offset 2, size 2
    ; DIM - declaration
    ; Create struct instance HERO of type PLAYER
    ; Struct size: 8 bytes
    ; Instance address: 0x6000
    ; DIM - declaration
    ; Create struct instance ENEMY of type PLAYER
    ; Struct size: 8 bytes
    ; Instance address: 0x6008
    ; DIM - declaration
    ; Create struct instance POSITION of type VEC2
    ; Struct size: 4 bytes
    ; Instance address: 0x6010
    ; DIM - declaration
    ; Create struct instance VELOCITY of type VEC2
    ; Struct size: 4 bytes
    ; Instance address: 0x6014
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'NoBASIC Struct Demo' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Hero Health:' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Enemy Health:' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Position:' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
DW 0  ; Variable HERO
ORG 0x2036
DW 0  ; Variable HEALTH
ORG 0x2038
DW 0  ; Variable ENEMY
ORG 0x203A
DW 0  ; Variable POSITION
ORG 0x4000
DB 78
DB 111
DB 66
