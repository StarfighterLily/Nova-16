...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing COLOR() function:' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; For RAMP = 0 To 15
...
for_end_2:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing RAMP() and SHADE() functions:' using TEXT
    MOV P0,0x4100
    MOV P1,15
    TEXT P0,P1
    ; TEST_COLORS = 
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '  RAMP: ' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; Load STR into P0
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string '  SHADE: ' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    ; Load STR into P0
...
for_end_6:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Original: ' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    ; Load STR into P0
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Recreated: ' using TEXT
    MOV P0,0x4A00
    MOV P1,15
    TEXT P0,P1
    ; Load STR into P0
...
display_value_done:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Match: ' using TEXT
    MOV P0,0x4B00
    MOV P1,15
    TEXT P0,P1
    ; Load STR into P0
