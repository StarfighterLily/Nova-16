...
start:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Testing error handling' using TEXT
    MOV P0,0x4000
    MOV P1,15
    TEXT P0,P1
    ; TRY block start
...
catch_1:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Caught division by zero error' using TEXT
    MOV P0,0x4200
    MOV P1,15
    TEXT P0,P1
try_end_2:
    ...
    MOV P0,5
    ; Calculate total memory needed: P0 * 2 + 2
    MOV P2,P0
    SHL P2,P2,1
    ADD P2,2
    ...
    ADD P3,P2
    MOV [0x5FFE],P3
    ; Store array size at 0x6000
    MOV [0x6000],P0
    ; Array ARRAY data address: 0x6002
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Array access successful' using TEXT
    MOV P0,0x4300
    MOV P1,15
    TEXT P0,P1
    ; Check error flag after TRY block
...
catch_3:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Caught array bounds error' using TEXT
    MOV P0,0x4400
    MOV P1,15
    TEXT P0,P1
try_end_4:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Invalid function result:' using TEXT
    MOV P0,0x4500
    MOV P1,15
    TEXT P0,P1
    MOV P0,VY
...
catch_5:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Caught invalid function error' using TEXT
    MOV P0,0x4600
    MOV P1,15
    TEXT P0,P1
try_end_6:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'String operation successful' using TEXT
    MOV P0,0x4700
    MOV P1,15
    TEXT P0,P1
    ; Check error flag after TRY block
...
catch_7:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Caught string bounds error' using TEXT
    MOV P0,0x4800
    MOV P1,15
    TEXT P0,P1
try_end_8:
...
catch_9:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Inner catch: division by zero' using TEXT
    MOV P0,0x4900
    MOV P1,15
    TEXT P0,P1
try_end_10:
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Inner try completed' using TEXT
    MOV P0,0x4A00
    MOV P1,15
    TEXT P0,P1
    ; Disp
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Outer catch: undefined variable' using TEXT
    MOV P0,0x4B00
    MOV P1,15
    TEXT P0,P1
    ...
    MOV P0,0
    MOV VL,P0
    ; Display string 'Error handling test complete' using TEXT
    MOV P0,0x4C00
    MOV P1,15
    TEXT P0,P1
